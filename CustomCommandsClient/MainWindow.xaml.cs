...
public partial class MainWindow : Window
{
    ...
    private void Connector_Recognizing(object sender, SpeechRecognitionEventArgs e) => UpdateStatus(e.Result.Text, tentative: true);
    ...
    private void RunOnUiThread(Action action) => Dispatcher.InvokeAsync(action);
